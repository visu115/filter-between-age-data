...
function filterAge(studentObj) {
    const belowAge = 13;
    const mostAge = 18;
    let ans = [];
  
    studentObj.forEach(studentData => {
      if (studentData.age >= belowAge && studentData.age <= mostAge){
        ans.push((studentData));
      }
    });
  ...
  console.log(filterAge(studentCopy))
